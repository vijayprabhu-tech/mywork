...
public class ConnectionOptions {
  ...
  public static final ConnectionOptions EMBEDDED_H2_CONNECTION = new ConnectionOptions(DataSourceDriver.EMBEDDED_H2);

  public static final ConnectionOptions EMBEDDED_DERBY_CONNECTION = new ConnectionOptions(
      DataSourceDriver.EMBEDDED_DERBY);

  public static final ConnectionOptions EMBEDDED_HSQL_CONNECTION = new ConnectionOptions(
      DataSourceDriver.EMBEDDED_HSQL);
